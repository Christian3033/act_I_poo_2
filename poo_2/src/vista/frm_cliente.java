...
public class frm_cliente extends javax.swing.JFrame {
     ...
     */
   Cliente_C obj_cliente;
    public frm_cliente() {
        initComponents();
        obj_cliente = new Cliente_C();
    }
    ...
    private void btn_aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_aceptarActionPerformed
        // TODO add your handling code here:
        obj_cliente = new Cliente_C(txt_nit.getText(),txt_nombre.getText(),txt_apellidos.getText(),txt_direccion.getText(),txt_telefono.getText(),txt_fn.getText());
        obj_cliente.agregar();
